...
.filtros{position:sticky; top:60px; z-index:20; background:rgba(11,13,17,.92); backdrop-filter:blur(10px);
...
@media (max-width:760px){
  ...
  .chips{width:100%; overflow-x:auto; scrollbar-width:none; padding-bottom:2px}
  .chips::-webkit-scrollbar{display:none}
}

/* ---------- os grupos ---------- */
main{padding:0 0 90px}
.grupo{padding:56px 0 0}
